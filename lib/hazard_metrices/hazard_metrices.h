...
inline PCLResult PrincipleComponentAnalysis(const std::string& file_path, float voxel_size = 0.45f, float slope_threshold = 20.0f, int k = 10) {
  ...
  std::cout << cloud->size() << " points from " << file_path << std::endl;
